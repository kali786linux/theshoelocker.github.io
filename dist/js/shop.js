...
const cardHeaders = [
    ...
    "Nike Air Force 1 UV colour changing",
    "Nike Solefly X Air Jordan 1 Art Basel",
...
const generateShoe = (num) => {
    const cardEl = `<div class="card">
                    <div class="card-img">
                        <a href="#" class="shoe-link" value="${cardHeaders[num]}"
                            ><img loading="lazy" src="images/output/shoepic${num}.jpg" alt="Pic"
                        />
                        </a>
                    </div>
                    <div class="card-header">${cardHeaders[num]}</div>
                    <div class="card-price">Contact for prices</div>
                </div>`;
...
shoeLinks.forEach((shoeLink) => {
    shoeLink.addEventListener("click", function () {
        ...
        cardsDiv.innerHTML = "";
        const itemEl = `<h2 class="item-header">${shoeLink.attributes[2].value}</h2>
                <div class="img-div">
                        ${shoeLink.innerHTML}
                </div>
                <form 
                    ...
                    <label for="shoe-name">
                        ...
                        <input
                            ...
                            value="${shoeLink.attributes[2].value}"
                            required
                        />
